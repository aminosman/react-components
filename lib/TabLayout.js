...
function TabLayout(_a) {
    var _this = this;
    var defaultActiveKey = _a.defaultActiveKey, nav = _a.nav, defaultPinnedTabs = _a.defaultPinnedTabs, title = _a.title, loading = _a.loading, navLinkContainerProps = _a.navLinkContainerProps, navContentContainerProps = _a.navContentContainerProps, onTitleEdit = _a.onTitleEdit, pinnedTabsStorageKey = _a.pinnedTabsStorageKey, onTabChange = _a.onTabChange, onPinToggle = _a.onPinToggle;
    ...
    var handlePinToggle = function (index) {
        ...
        setPinnedTabs(copy);
        onPinToggle === null || onPinToggle === void 0 ? void 0 : onPinToggle(tabId, newPinned);
    };
                        ...
                        return (0, tslib_1.__generator)(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    setCurrentTab(x.id);
                                    setShowAll(false);
                                    onTabChange === null || onTabChange === void 0 ? void 0 : onTabChange(x.id);
                                    return [2 /*return*/];
                            }
                        });
